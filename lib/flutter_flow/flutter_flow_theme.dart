...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color burgundy = const Color(0xFF8B1108);
  late Color orange = const Color(0xFFBC5B2C);
  late Color lightGreen = const Color(0xFFD0DB5F);
  late Color darkGreen = const Color(0xFF56572F);
  late Color beige = const Color(0xFFFFF8E5);
