...
import '/components/add_recipe_widget.dart';
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('USER_RECIPIES_PAGE_Icon_z4uwe1uu_ON_TAP');
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return wrapWithModel(
                                          model: _model.recipeModels1.getModel(
                                            listViewRecipesRecord.reference.id,
                                            listViewIndex,
                                          ),
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: RecipeWidget(
                                            key: Key(
                                              'Keyjq3_${listViewRecipesRecord.reference.id}',
                                            ),
                                            recipeTitle:
                                                listViewRecipesRecord.title,
                                            recipePicture: listViewRecipesRecord
                                                .picturePath,
                                            recipeDescription:
                            ...
                            SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<UserRecipesRecord>>(
                                    stream: queryUserRecipesRecord(
                                      queryBuilder: (userRecipesRecord) =>
                                          userRecipesRecord.where(
                                        'user',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<UserRecipesRecord>
                                          listViewUserRecipesRecordList =
                                          snapshot.data!;
                                      ...
                                      return ListView.builder(
                                        ...
                                        shrinkWrap: true,
                                        scrollDirection: Axis.vertical,
                                        itemCount: listViewUserRecipesRecordList
                                            .length,
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewUserRecipesRecord =
                                              listViewUserRecipesRecordList[
                                                  listViewIndex];
                                          return wrapWithModel(
                                            model:
                                                _model.recipeModels2.getModel(
                                              listViewUserRecipesRecord
                                                  .reference.id,
                                              listViewIndex,
                                            ),
                                            updateCallback: () =>
                                            ...
                                            child: RecipeWidget(
                                              key: Key(
                                                'Key49w_${listViewUserRecipesRecord.reference.id}',
                                              ),
                                              recipeTitle:
                                                  listViewUserRecipesRecord
                                                      .title,
